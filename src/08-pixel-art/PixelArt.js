...
function Pixel() {
    ...
    const [pixelColors, setPixelColors] = useState('lightGrey');
    return <div onClick={() => setPixelColors(color)} style={{ height: '20px', width: '20px', backgroundColor: pixelColors, margin: '1px' }} />
}
